...
import Myinsta from "./myinsta-clone.jpg"
         ...
         <div style={{ display: "flex", flexDirection: "column" }}>
                  ...
                  <Accordion style={{ background: "rgba(26,26,26)", color: "white", borderRadius: "20px" }} expanded={expanded === 'panel1'} onChange={handleChange('panel1')}>
                      ...
                      <AccordionDetails style={{ background: "rgba(20, 20, 20)", color: "white", borderRadius: " 0px 0px 20px 20px", fontSize: "1rem" }}>
                          ...
                          Created a MyInsta Clone website enabling users to add posts and comments via desktop, with an API for default posts.The user-friendly UI includes a shimmer effect for enhanced loading visuals.
                          </Typography>
                          <Typography textAlign={{ xs: "start", sm: "justify", md: "justify" }} >
                          Features include user authentication, post creation, commenting, and a responsive design for seamless device compatibility.
                          </Typography>
                      </AccordionDetails>
                  </Accordion>
                  <Box
                ...
                >
                    <a style={{ display: 'flex', justifyContent: "center", alignItems: "center" }} href="https://my-insta-simmi.netlify.app/"><LinkIcon style={{ color: "20a4b6", fontSize: "2rem", marginRight: "1rem" }} /><u>my-insta-simmi.netlify.app</u></a>
                </Box>
