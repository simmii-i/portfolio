         ...
         <div style={{ display: "flex", flexDirection: "column" }}>
                  ...
                  <Accordion style={{ background: "rgba(26,26,26)", color: "white", borderRadius: "20px" }} expanded={expanded === 'panel1'} onChange={handleChange('panel1')}>
                      ...
                      <AccordionDetails style={{ background: "rgba(20, 20, 20)", color: "white", borderRadius: " 0px 0px 20px 20px", fontSize: "1rem" }}>
                          ...
                          Built with React.js, my portfolio website boasts rapid loading times and seamless transitions. It's designed with a sleek dark theme that ensures aesthetic appeal and fits seamlessly on every screen size.
                          </Typography>
                          <Typography textAlign={{ xs: "start", sm: "justify", md: "justify" }} >
                          This website serves as a comprehensive showcase for my projects, skills, resume, and education, all in one accessible place. With a user-friendly interface, it provides easy navigation and presents my professional profile cohesively.
                          </Typography>
                      </AccordionDetails>
                  </Accordion>
                  <Box
                ...
                >
                    <a style={{ display: 'flex', justifyContent: "center", alignItems: "center" }} href=""><LinkIcon style={{ color: "20a4b6", fontSize: "2rem", marginRight: "1rem" }} /><u>simmii-portfolio.netlify.app</u></a>
                </Box>
